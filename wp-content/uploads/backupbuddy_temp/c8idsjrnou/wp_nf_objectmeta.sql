CREATE TABLE `wp_nf_objectmeta` (  `id` bigint(20) NOT NULL AUTO_INCREMENT,  `object_id` bigint(20) NOT NULL,  `meta_key` varchar(255) NOT NULL,  `meta_value` longtext NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=76 DEFAULT CHARSET=utf8;
/*!40000 ALTER TABLE `wp_nf_objectmeta` DISABLE KEYS */;
INSERT INTO `wp_nf_objectmeta` VALUES('1', '1', 'date_updated', '2016-06-21');
